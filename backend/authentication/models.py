...
class AccountManager(BaseUserManager):
    def create_user(self, police_station_uid, phone, password=None):
    ...
    def create_superuser(self, police_station_uid, phone, password):
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    location = models.CharField(verbose_name="location", max_length=300, default="", null=True, blank=True)
    phone = models.CharField(verbose_name="phone", max_length = 10, default="")
    email = models.EmailField(verbose_name="email",max_length=60, default="", null=True, blank=True)
